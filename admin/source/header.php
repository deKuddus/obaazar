...
<head>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="bresource/ower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  ...
  function deleteById(id){
    $.ajax({
              url:"ajax_load/about_by_ajax.php",
              method:"POST",
              data:{id:id},
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="resource/dist/img/ustc.png" class="user-image" alt="User Image">
